...
//        }
    ...
    @ResponseBody
    public void likeup(@RequestBody LikeVo likeVo) {
        System.out.println("좋아요");
        System.out.println(likeVo.getBoardNo());
        System.out.println(likeVo.getUserId());
        communityService.likeUp(likeVo.getBoardNo(), likeVo.getUserId());
    ...
    @ResponseBody
    public void likeDown(@RequestBody LikeVo likeVo) {
        System.out.println("좋아요 취소");
        communityService.likeDown(likeVo.getBoardNo(), likeVo.getUserId());
    }
